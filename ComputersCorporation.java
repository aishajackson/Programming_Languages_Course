...
public class ComputersCorporation extends Applet implements ItemListener
{
  ...
  Label shippingLabel = new Label ("Please choose the extra peripheral devices you need:");
